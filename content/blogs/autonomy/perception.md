...
<figure>
    ...
    <tr style="border:0;">
        ...
        <img src="/pictures/Blogs/new_yolo_data_1.png" width="100%" style="display:block;" />
        </td>
        <td align="center" width="40%" style="border:0; padding:0; margin:0;">
        <img src="/pictures/Blogs/new_yolo_data_2.png" width="100%" style="display:block;" />
        </td>
    </tr>
    </table>
</figure>

<figcaption>Fig 1. Training data for the YOLO11n model from Roboboat 2025.</figcaption>
...
<figcaption>Fig 2. Our perception system detecting red and green buoys.</figcaption>
...
<figcaption>Fig 3. Computing the buoys' positions using LiDAR-camera fused data.</figcaption>
...
<figcaption>Fig 3. 3D point cloud generated occupancy grid.</figcaption>
