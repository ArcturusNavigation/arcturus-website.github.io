...
- We encountered some communication issues. The central hub wouldnâ€™t communicate with Jetson. The E-stop was working fine, but the Jetson couldn't read the status of the E-stop, so we could not operate the boat. 
