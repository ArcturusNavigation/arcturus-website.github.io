...
<figcaption>Fig 1. Our low-level control strategy: the path-following PID controller on the left, and a visualization of the potential field method used for avoiding obstacles on the right.</figcaption>
...
<figcaption>Fig 2. Robot Dynamics Model.</figcaption>
